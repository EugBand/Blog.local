...
/* posts/new.html.twig */
class __TwigTemplate_a490263b5dc44750ade6fecf41370efbb696d7023f5e99d915fe23220c4cef75 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 6
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 6, $this->source); })()), "body", [], "any", false, false, false, 6), 'row', ["attr" => ["rows" => "10", "cols" => "10"]]);
        // line 8
        echo "
...
";
    ...
    {
        return array (  83 => 10,  79 => 8,  77 => 6,  73 => 5,  68 => 4,  58 => 3,  35 => 1,);
    }
...
{% block body %}
    ...
    <button class=\"btn btn-default\" type=\"submit\">Сохранить</button>
    {{ form_end(form) }}
{% endblock %}", "posts/new.html.twig", "D:\\Install\\OSPanel\\domains\\localhost\\blog.local\\templates\\posts\\new.html.twig");
    }
}
