...
class __TwigTemplate_8b604cf53faed578f58d61db65544316003725209f81ff57cda5df926803cff4 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["post"]) {
            // line 7
            echo "        <a href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("blog_show", ["slug" => twig_get_attribute($this->env, $this->source, $context["post"], "slug", [], "any", false, false, false, 7)]), "html", null, true);
            echo "\">";
...
{% block body %}
    ...
    {% endfor %}
{% endblock %}", "posts/index.html.twig", "D:\\Install\\OSPanel\\domains\\localhost\\blog.local\\templates\\posts\\index.html.twig");
    }
}
